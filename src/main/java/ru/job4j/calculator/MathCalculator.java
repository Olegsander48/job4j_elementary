...
public class MathCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Разность и деление: " + differenceAndDivision(10, 20));
        System.out.println("Сумма, произведение, разность и деление: " + sumAndMultiplyAndDifferenceAndDivision(10, 20));
    }
}
